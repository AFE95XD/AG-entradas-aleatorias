...
'''CRUCE 2 PUNTOS : Ruleta'''
def cruce2PElitista(tablaNueva, poblacion, longitud, rangoMin, rangoMax, tazaCruce):
...
'''CRUCE 2 PUNTOS : Jerarquico'''
def cruce2PJerarElitista(tablaNueva, poblacion, longitud, rangoMin, rangoMax, tazaCruce):
