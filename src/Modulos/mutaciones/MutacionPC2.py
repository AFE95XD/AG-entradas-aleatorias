import random
from ..cruces.CruceD2P import cruce2P, cruce2PAuto, cruce2PJerar, cruce2PAutoJerar, cruce2PTorneo, cruce2PAutoTorneo, cruce2PElitista, cruce2PJerarElitista, cruce2PTorneoElitista
...
'''MUTACION SIMPLE : Ruleta + Cruce de 2 puntos'''
def mutacionPC2Elitista(tablaNueva, poblacion, longitud, rangoMin, rangoMax, tazaCruce, tazaMutacion):
    tabla, valoresLongitud = cruce2PElitista(tablaNueva, poblacion, longitud, rangoMin, rangoMax, tazaCruce)
    # tazaMutacion = int(input("\nPor favor ingrese la Taza de Mutacion: "))
...
'''MUTACION SIMPLE : Jerarquica + Cruce de 2 puntos'''
def mutacionPC2JerarElitista(tablaNueva, poblacion, longitud, rangoMin, rangoMax, tazaCruce, tazaMutacion):
    tabla, valoresLongitud = cruce2PJerarElitista(tablaNueva, poblacion, longitud, rangoMin, rangoMax, tazaCruce)
    # tazaMutacion = int(input("\nPor favor ingrese la Taza de Mutacion: "))
...
'''MUTACION SIMPLE: Torneo + Cruce de 2 puntos'''
def mutacionPC2TorneoElitista(tablaNueva, poblacion, longitud, rangoMin, rangoMax, tazaCruce, tazaMutacion):
    tabla, valoresLongitud = cruce2PTorneoElitista(tablaNueva, poblacion, longitud, rangoMin, rangoMax, tazaCruce)
    # tazaMutacion = int(input("\nPor favor ingrese la Taza de Mutacion: "))
